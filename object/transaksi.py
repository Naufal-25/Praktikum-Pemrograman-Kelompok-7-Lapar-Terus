...
class Transaksi:
    ...
    def to_text(self):
        return f"{self.id_transaksi},{self.pembeli.id_pembeli},{self.pembeli.nama},{self.pembeli.kontak},{self.status},{self.total}"
    ...
    def from_text(line):
        ...
        return Transaksi(id_transaksi, pembeli, status, float(total))